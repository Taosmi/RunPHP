...
class dalMySQL implements iDAL {
     ...
     * 
     * @throws  EXTException() if the connection could not be established
     */
     ...
     * 
     * @throws  EXTException() if the connection could not be closed
     */
    ...
    public function add ($data) {
        ...
        // Returns the autogenerated item ID if available.
        $lastId = mysql_insert_id($this->link);
        if ($lastId) {
            return $lastId;
        }
        // Returns the query result if no id was autogenerated.
        return $qResult;
    }
